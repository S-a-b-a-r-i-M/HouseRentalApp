...
//    const val COLUMN_OPEN_PARKING = "open_parking"
    ...
    const val COLUMN_TOTAL_FLOORS = "total_floors"
    ...
    const val COLUMN_LOCK_IN_PERIOD = "lock_in_period" // number of months
    // TIMELINE ---------->
    ...
    const val CREATE_TABLE = """
        CREATE TABLE $TABLE_NAME (
            ...
            $COLUMN_MAINTENANCE_CHARGES REAL,
            $COLUMN_SECURITY_DEPOSIT INTEGER,
            $COLUMN_LOCK_IN_PERIOD INTEGER,
